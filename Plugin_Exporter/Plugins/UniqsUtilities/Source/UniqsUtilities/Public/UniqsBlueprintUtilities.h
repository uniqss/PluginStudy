...
#include "UniqsBlueprintUtilities.generated.h"

/**
 *
 */
UCLASS()
class UNIQSUTILITIES_API UUniqsBlueprintUtilities : public UBlueprintFunctionLibrary
{
	GENERATED_BODY()
...
public:
	...
	*/
	UFUNCTION(BlueprintPure, Category = "Uniqs|Utilites::BlueprintLibrary", meta = (DisplayName = "Uniqs::Get All Actors With Component", WorldContext = "WorldContextObject", DeterminesOutputType = "Component", DynamicOutputParam = "OutActorComponents"))
	 ...
	 */
	UFUNCTION(BlueprintPure, Category = "Uniqs|Utilites::BlueprintLibrary", meta = (DisplayName = "Uniqs::Get Actor By ID Name and Class", WorldContext = "WorldContextObject", DeterminesOutputType = "ActorClass"))
	 ...
	 */
	UFUNCTION(BlueprintPure, Category = "Uniqs|Utilites::BlueprintLibrary", meta = (DisplayName = "Uniqs::Get Actor By ID Name from Array of Actors"))
	 ...
	 */
	UFUNCTION(BlueprintPure, Category = "Uniqs|Utilites::BlueprintLibrary", meta = (WorldContext = "WorldContextObject", UnsafeDuringActorConstruction = "true", DisplayName = "Uniqs::Get Unique Actor of this class in the world"))
	 ...
	 */
	UFUNCTION(BlueprintPure, Category = "Uniqs|Utilites::BlueprintLibrary", meta = (DisplayName = "Uniqs::Get Level Owner From Actor"))
